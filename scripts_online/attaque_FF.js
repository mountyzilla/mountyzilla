...
function treateMission() {
	...
	var nodes = document.evaluate(
			"//option[starts-with(@value,'ME')]", document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
	...
	for(var i=0;i<nodes.snapshotLength;i++)
	{
		...
		var idMonstre = node.childNodes[0].nodeValue;
		var nomMonstre = idMonstre.substring(idMonstre.indexOf(" - ")+3,idMonstre.length);
		idMonstre = idMonstre.substring(0,idMonstre.indexOf(" - "))*1;
